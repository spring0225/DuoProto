...
def get_class_idxs(X_train):
    """Get class indices for multi-class data (0, 1, 2, 3)"""
    class_idxs = []
    class_idxs_0 = []
    class_idxs_1 = []
    class_idxs_2 = []
    ...
    for i in range(len(X_train)):
        ...
        if classes == 0:
            ...
            class_idxs_3.append(i)
    class_idxs.append(class_idxs_0)
    class_idxs.append(class_idxs_1)
    class_idxs.append(class_idxs_2)
    class_idxs.append(class_idxs_3)

    return class_idxs

def get_class_idxs_bc(X_train):
    """Get class indices for binary classification (0, 1)"""
    class_idxs = []
    class_idxs_0 = []
    class_idxs_1 = []
